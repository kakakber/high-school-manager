...
function Session(sessionId) {
    ...
    // Seriously spaggiari what the fuck is up with your naming conventions
    this.global_base_url = 'https://web.spaggiari.eu/home/app/default/';
    this.base_url = 'https://web.spaggiari.eu/cvv/app/default/';
    this.family_base_url = 'https://web.spaggiari.eu/fml/app/default/';
    ...
    this.notes = () => {
        return this.request(this.family_base_url + 'gioprof_note_studente.php')
            .then(res => {
                var $ = cheerio.load(res),
                    notes = [];
                if ($('.name').length) {
                    $('#sort_table tbody tr').each(function (i, e) {
                        var entry = $(this),
                            note = {};
                        entry.children('td').each(function (i, e) {
