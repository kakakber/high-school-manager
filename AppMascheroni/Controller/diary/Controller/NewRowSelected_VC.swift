...
class EventoDiario{
    ...
    init(id: String, tipo: String, data: String, descrizione: String) {//inizializzazione
        self.id = id
        self.tipo = tipo
        self.data = data
...
var eventoScelto = EventoDiario(id: idV,tipo: tipoV, data: dataV, descrizione: descrizioneV)
...
class NewRowSelected_VC: UIViewController{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //initFunc()
        eventoScelto = EventoDiario(id: idV,tipo: tipoV, data: dataV, descrizione: descrizioneV)
        
        tipoText.addTarget(self, action: #selector(NewRowSelected_VC.textFieldDidChange(_:)), for: UIControlEvents.editingChanged)
