    ...
    */
    private func roundHeight() -> CGFloat {
        ...
        if let font = font {
            ...
            let size = text.boundingRect(with: boundingSize, options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: attributes as [NSAttributedStringKey : Any], context: nil)
